...
=== 1.5 서비스 이용 약관 (POST /login/terms)
==== 요청
include::{snippets}/login-controller-test/check-service-terms/http-request.adoc[]
요청 헤더
include::{snippets}/login-controller-test/check-service-terms/request-headers.adoc[]
요청 쿠키
include::{snippets}/login-controller-test/check-service-terms/request-cookies.adoc[]
include::{snippets}/login-controller-test/check-service-terms/request-fields.adoc[]
==== 응답
include::{snippets}/login-controller-test/check-service-terms/http-response.adoc[]
...
=== 2.6 요약 노트 생성 ( POST /chat/:chatRoomId/summary/v2 )
==== 요청
include::{snippets}/chat-controller-test/create-note-v2/http-request.adoc[]
include::{snippets}/chat-controller-test/create-note-v2/path-parameters.adoc[]
==== 응답
include::{snippets}/chat-controller-test/create-note-v2/http-response.adoc[]
include::{snippets}/chat-controller-test/create-note-v2/response-fields.adoc[]
...
=== 2.10 요약 노트 생성 ( POST /chat/:chatRoomId/summary/v1 )
==== 요청
include::{snippets}/chat-controller-test/create-note-v1/http-request.adoc[]
include::{snippets}/chat-controller-test/create-note-v1/path-parameters.adoc[]
==== 응답
include::{snippets}/chat-controller-test/create-note-v1/http-response.adoc[]
include::{snippets}/chat-controller-test/create-note-v1/response-fields.adoc[]
...
=== 3.4 기획서 자동 완성하기 ( POST /note/:noteId/completion/v2 )
==== 요청
include::{snippets}/note-controller-test/get-automated-proposal-v2/http-request.adoc[]
include::{snippets}/note-controller-test/get-automated-proposal-v2/path-parameters.adoc[]
==== 응답
include::{snippets}/note-controller-test/get-automated-proposal-v2/http-response.adoc[]
include::{snippets}/note-controller-test/get-automated-proposal-v2/response-fields.adoc[]

=== 3.4 기획서 자동 완성하기 ( POST /note/:noteId/completion/v1 )
==== 요청
include::{snippets}/note-controller-test/get-automated-proposal-v1/http-request.adoc[]
include::{snippets}/note-controller-test/get-automated-proposal-v1/path-parameters.adoc[]
==== 응답
include::{snippets}/note-controller-test/get-automated-proposal-v1/http-response.adoc[]
include::{snippets}/note-controller-test/get-automated-proposal-v1/response-fields.adoc[]
