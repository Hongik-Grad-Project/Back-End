...
include::{snippets}/chat-controller-test/create-chat-room/response-headers.adoc[]

=== 2.2 메시지 보내기 ( POST /chat/:chatRoomId/message/v1 )
==== 요청
include::{snippets}/chat-controller-test/create-message/http-request.adoc[]
include::{snippets}/chat-controller-test/create-message/path-parameters.adoc[]
==== 응답
include::{snippets}/chat-controller-test/create-message/http-response.adoc[]
